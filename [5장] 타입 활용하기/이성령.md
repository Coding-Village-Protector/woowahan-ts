...
> 📣 (2)(3)챕터의 경우 설명만으로 충분치 않아 [ChatGPT](<(https://chat.openai.com/share/dc353d0e-7085-4a81-a1ae-677004e5dadc)>)의 도움을 받아 새로 이해한 내용을 토대로 정리했습니다. 책과 예시 코드는 동일하지만 세부 설명이 다름을 명시합니다.
...
1번의 문제가 발생하지 않는 다른 방법은 **직접 커스텀 유틸리티 타입을 만들어내는 것**이다.
